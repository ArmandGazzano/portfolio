...
const links = [
    ...
    { label: 'armand.gazzano@gmail.com', url: 'mailto:armand.gazzano@gmail.com', Icon: MailIcon },
];

export default function Contact() {
    const { t, i18n } = useTranslation();
    const [ref, inView] = useInView();
    const cvUrl = i18n.language === 'fr' ? '/CV_Armand_Gazzano_FR.pdf' : '/CV_Armand_Gazzano_EN.pdf';
